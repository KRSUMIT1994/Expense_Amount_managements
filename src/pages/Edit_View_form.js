...
export default class Edit_View_form extends Component {
    constructor(props) {
        super(props);
        this.state = {
            category:'',
            ...
            date: '',
            Userid: '',
            switchValue: props.detail_edit.extra_expanse == 0 ? false : true

        };
        //  alert(JSON.stringify(props.detail_edit))
    }
                ...
                <ScrollView>
                    ...
                    <View style={{ flexDirection: 'row', margin: 15, justifyContent:'space-between' }}>
                        ...
                        <TextInput style={styles.tittleBox}
                            placeholder={this.props.detail_edit.title}
                    ...
                    <View style={{ flexDirection: 'row', margin: 3, justifyContent: 'space-between' }}>
                        ...
                        <TextInput style={styles.amountBox}
                            placeholder={this.props.detail_edit.amount}
                            placeholderTextColor='#ffffff'
                            underlineColorAndroid="transparent"
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'space-between' }}>
                        ...
                        <View style={styles.datePickers}>
                            <DatePicker
                                ...
                                mode="date"
                                placeholder={this.props.detail_edit.date}
